...
<div class="content-wrapper">
	<div class="col-md-12" id="page-content">
		...
		<a href="#newRequest" data-toggle="modal"
			class="btn btn-sm btn-primary">Add Transaction</a> <br> <br>
										...
										<td style="text-align: center">
											<form action="processAccTransaction" method="post">
												<input type="hidden" name="transactionID"
													value="${transaction.id}"> <input type="hidden"
													name="extUserID" value="${extUserID}"> <input
													type="hidden" name="${_csrf.parameterName}"
													value="${_csrf.token}" /> <select id="requestType"
				...
				<div class="modal-body no-padding">
					<div class="panel panel-success no-margin">
						...
						<div class="panel-body">
							<form class="form-horizontal" action="newaccTransaction"
								method="POST">
								<fieldset>
									<div class="form-group">
										...
										<label for="receiverAccount" class="col-lg-3 control-label">Receiver
											Account</label>
										<div class="col-lg-9 form-margin">
											<input type="text" class="form-control" id="receiverAccount"
										...
										<input type="hidden" name="${_csrf.parameterName}"
											...
											name="extUserID" value="${extUserID}">
